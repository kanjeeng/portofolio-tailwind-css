...
export default function Project() {
  return (
    <>
      ...
      <header className="bg-transparent absolute top-0 left-0 w-full flex items-center z-10">
        <div className="container">
          <div className="flex items-center justify-between relative">
            <div className="px-4">
              <a href="#project" className="font-bold text-lg text-primary block py-6">kand</a>
            </div>
      ...
      {/* Back to top Start */}
      <a href="#project" className="fixed hidden justify-center items-center bottom-4 right-4 z-[9999] h-14 w-14 bg-primary rounded-full p-4 hover:animate-pulse" id="to-top">
