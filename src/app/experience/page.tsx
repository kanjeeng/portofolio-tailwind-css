...
export default function Home() {
  return (
    <>
      ...
      <header className="bg-transparent absolute top-0 left-0 w-full flex items-center z-10">
        <div className="container">
          <div className="flex items-center justify-between relative">
            <div className="px-4">
              <a href="#pengalaman" className="font-bold text-lg text-primary block py-6">kand</a>
            </div>
            <div className="flex items-center px-4">
              ...
              max-w-[250px] w-full right-4 top-full lg:block lg:static lg:bg-transparent lg:max-w-full lg:shadow-none lg:rounded-none">
                <ul className="block lg:flex">
                  ...
                  <li className="group">
                    <a href="#pengalaman" className="text-base text-dark py-2 mx-8 flex group-hover:text-primary">
                      Pengalaman</a>
                  </li>
                  <li className="group">
          ...
          <div className="flex flex-wrap">
            ...
            <div className="w-full px-4 mb-12 md:w-1/3">
              ...
              <ul className="text-slate-300">
                ...
                <li>
                  <a href="#pengalaman" className="inline-block text-base text-secondary hover:text-primary mb-3">Pengalaman</a>
                </li>
                <li>
      ...
      {/* Back to top Start */}
      <a href="#pengalaman" className="fixed hidden justify-center items-center bottom-4 right-4 z-[9999] h-14 w-14 bg-primary rounded-full p-4 hover:animate-pulse" id="to-top">
